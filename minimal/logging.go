...
func (m *Minimal) Sub(a ...any) error {
	return m.writeArgs(false, AnsiSub, prefixSub, a...)
}
...
func (m *Minimal) Subf(format string, a ...any) error {
	return m.writeFormat(false, AnsiSub, prefixSub, format, a...)
}
...
func (m *Minimal) Infof(format string, a ...any) error {
	return m.writeFormat(false, AnsiInfo, prefixInfo, format, a...)
}
...
func (m *Minimal) Successf(format string, a ...any) error {
	return m.writeFormat(false, AnsiSuccess, prefixSuccess, format, a...)
}
...
func (m *Minimal) Successln(a ...any) error {
	return m.writeArgsLine(false, AnsiSuccess, prefixSuccess, a...)
}

// Warn writes its operands to the standard target as a warning.
func (m *Minimal) Warn(a ...any) error {
	return m.writeArgs(false, AnsiWarn, prefixWarn, a...)
}
...
func (m *Minimal) Errorf(format string, a ...any) error {
	return m.writeFormat(true, AnsiError, prefixError, format, a...)
}
...
func (m *Minimal) Errorln(a ...any) error {
	return m.writeArgsLine(true, AnsiError, prefixError, a...)
}
...
func (m *Minimal) Write(color string, a ...any) error {
	return m.writeArgs(false, color, "", a...)
}
...
func (m *Minimal) Writef(color, format string, a ...any) error {
	return m.writeFormat(false, color, "", format, a...)
}
...
func (m *Minimal) Writeln(color string, a ...any) error {
	return m.writeArgsLine(false, color, "", a...)
}
...
func (m *Minimal) MustFail(err error) {
	...
	m.writeArgsLine(true, AnsiError, prefixError, err)
